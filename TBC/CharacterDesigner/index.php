...
class Home extends Site{
	...
	private function getEnchantmentTemplate($db){
		foreach($db->query('SELECT * FROM `armory-enchantmentstats-tbc` WHERE enchid IN ('.implode(",", $this->enchantids).','.implode(",",$this->socketids).')') as $row){
	...
	private function getStatValues(){
		...
		for ($i=1; $i<20; $i++){
			if ($i==19){
				...
				if (isset($this->enchantids[$i])){
					...
					$this->statValues[59] += $this->enchTemplate[$this->enchantids[$i]]->spellhaste;
		...
		for ($i=1; $i<20; $i++){
			...
			$this->statValues[59] += $this->itemTemplate[$this->items[$i]]->spellhaste;
			$this->statValues[60] += $this->itemTemplate[$this->items[$i]]->resilience;
		}
		
		$this->statValues[12] += 350;
		switch($this->classid){
			case 1 :
				...
				$defense = $this->statValues[12]-350; // Gotta add this for tbc
		...
		if ($this->classid!=2 && $this->classid!=1){
			...
			if ($this->userData->classid==6 && $this->talentid==1)
	...
	public function content(){
		...
		<div class="container cont" id="container">
			...
			<section class="centredNormal" style="overflow: hidden;">
				<section class="sleft">
					<div class="desRow">
						...
						<select name="ench1">
							...
							<option value="3007"'.($r = ($this->enchantids[1]==3007) ? "selected" : "").'>+20 Fire Resistance</option>
							<option value="3009"'.($r = ($this->enchantids[1]==3009) ? "selected" : "").'>+20 Shadow Resistance</option>
					...
					<div class="desRow">
						...
						<select name="ench15">
							...
							<option value="744"'.($r = ($this->enchantids[15]==744) ? "selected" : "").'>+20 Armor</option>
							...
							<option value="1257"'.($r = ($this->enchantids[15]==1257) ? "selected" : "").'>+15 Arcane Resistance</option>
							...
							<option value="1889"'.($r = ($this->enchantids[15]==1889) ? "selected" : "").'>+70 Armor</option>
					...
					<div class="desRow">
						...
						<select name="ench5">
							...
							<option value="15"'.($r = ($this->enchantids[5]==15) ? "selected" : "").'>Reinforced (+8 Armor)</option>
							<option value="17"'.($r = ($this->enchantids[5]==17) ? "selected" : "").'>Reinforced (+24 Armor)</option>
							<option value="24"'.($r = ($this->enchantids[5]==24) ? "selected" : "").'>+5 Mana</option>
							<option value="41"'.($r = ($this->enchantids[5]==41) ? "selected" : "").'>+5 Health</option>
							...
							<option value="1843"'.($r = ($this->enchantids[5]==1843) ? "selected" : "").'>Reinforced (+40 Armor)</option>
							<option value="1892"'.($r = ($this->enchantids[5]==1892) ? "selected" : "").'>+100 Health</option>
							...
							<option value="2985"'.($r = ($this->enchantids[5]==2985) ? "selected" : "").'>+8 Fire Resist</option>
					...
					<div class="desRow">
						...
						<select name="ench9">
							...
							<option value="41"'.($r = ($this->enchantids[9]==41) ? "selected" : "").'>+5 Health</option>
							<option value="369"'.($r = ($this->enchantids[9]==369) ? "selected" : "").'>+12 Intellect</option>
							<option value="724"'.($r = ($this->enchantids[9]==724) ? "selected" : "").'>+3 Stamina</option>
							...
							<option value="924"'.($r = ($this->enchantids[9]==924) ? "selected" : "").'>+2 Defense Rating</option>
							...
							<option value="1886"'.($r = ($this->enchantids[9]==1886) ? "selected" : "").'>+9 Stamina</option>
					...
					<div class="desRow">
						...
						<select name="ench10">
							...
							<option value="15"'.($r = ($this->enchantids[10]==15) ? "selected" : "").'>Reinforced (+8 Armor)</option>
							...
							<option value="856"'.($r = ($this->enchantids[10]==856) ? "selected" : "").'>+5 Strength</option>
							<option value="930"'.($r = ($this->enchantids[10]==930) ? "selected" : "").'>+2% Mount Speed</option>
							<option value="931"'.($r = ($this->enchantids[10]==931) ? "selected" : "").'>+10 Haste Rating</option>
							<option value="1594"'.($r = ($this->enchantids[10]==1594) ? "selected" : "").'>+26 Attack Power</option>
							<option value="1843"'.($r = ($this->enchantids[10]==1843) ? "selected" : "").'>Reinforced (+40 Armor)</option>
							...
							<option value="2985"'.($r = ($this->enchantids[10]==2985) ? "selected" : "").'>+8 Fire Resist</option>
					...
					<div class="desRow">
						...
						<select name="ench7">
							...
							<option value="15"'.($r = ($this->enchantids[7]==15) ? "selected" : "").'>Reinforced (+8 Armor)</option>
					...
					<div class="desRow">
						...
						<select name="ench8">
							...
							<option value="15"'.($r = ($this->enchantids[8]==15) ? "selected" : "").'>Reinforced (+8 Armor)</option>
							<option value="17"'.($r = ($this->enchantids[8]==17) ? "selected" : "").'>Reinforced (+24 Armor)</option>
							<option value="66"'.($r = ($this->enchantids[8]==66) ? "selected" : "").'>+1 Stamina</option>
							...
							<option value="849"'.($r = ($this->enchantids[8]==849) ? "selected" : "").'>+3 Agility</option>
							...
							<option value="1843"'.($r = ($this->enchantids[8]==1843) ? "selected" : "").'>Reinforced (+40 Armor)</option>
							...
							<option value="2984"'.($r = ($this->enchantids[8]==2984) ? "selected" : "").'>+8 Shadow Resist</option>
							<option value="2985"'.($r = ($this->enchantids[8]==2985) ? "selected" : "").'>+8 Fire Resist</option>
						</select>
					...
					<div class="desRow">
						...
						<select name="ench11">
							...
							<option value="2929"'.($r = ($this->enchantids[11]==2929) ? "selected" : "").'>+2 Weapon Damage</option>
					...
					<div class="desRow">
						...
						<select name="ench12">
							<option value="0"'.($r = ($this->enchantids[12]==0) ? "selected" : "").'>None</option>
							<option value="2928"'.($r = ($this->enchantids[12]==2928) ? "selected" : "").'>+12 Spell Damage</option>
							<option value="2929"'.($r = ($this->enchantids[12]==2929) ? "selected" : "").'>+2 Weapon Damage</option>
							<option value="2930"'.($r = ($this->enchantids[12]==2930) ? "selected" : "").'>+20 Healing and +7 Spell Damage</option>
							<option value="2931"'.($r = ($this->enchantids[12]==2931) ? "selected" : "").'>+4 All Stats</option>
						</select>
					...
					<div class="desRow">
						...
						<select name="ench16">
							...
							<option value="241"'.($r = ($this->enchantids[16]==241) ? "selected" : "").'>+2 Weapon Damage</option>
							...
							<option value="805"'.($r = ($this->enchantids[16]==805) ? "selected" : "").'>+4 Weapon Damage</option>
							<option value="853"'.($r = ($this->enchantids[16]==853) ? "selected" : "").'>+6 Beastslaying</option>
							...
							<option value="2646"'.($r = ($this->enchantids[16]==2646) ? "selected" : "").'>+25 Agility</option>
							...
							<option value="2674"'.($r = ($this->enchantids[16]==2674) ? "selected" : "").'>Spellsurge</option>
							...
							<option value="3273"'.($r = ($this->enchantids[16]==3273) ? "selected" : "").'>Deathfrost</option>
						</select>
					...
					<div class="desRow">
						...
						<select name="ench17">
							...
							<option value="66"'.($r = ($this->enchantids[17]==66) ? "selected" : "").'>+1 Stamina</option>
							...
							<option value="805"'.($r = ($this->enchantids[17]==805) ? "selected" : "").'>+4 Weapon Damage</option>
							<option value="912"'.($r = ($this->enchantids[17]==912) ? "selected" : "").'>Demonslaying</option>
							<option value="929"'.($r = ($this->enchantids[17]==929) ? "selected" : "").'>+7 Stamina</option>
							<option value="963"'.($r = ($this->enchantids[17]==963) ? "selected" : "").'>+7 Weapon Damage</option>
							<option value="1071"'.($r = ($this->enchantids[17]==1071) ? "selected" : "").'>+18 Stamina</option>
							<option value="1890"'.($r = ($this->enchantids[17]==1890) ? "selected" : "").'>+9 Spirit</option>
							...
							<option value="2655"'.($r = ($this->enchantids[17]==2655) ? "selected" : "").'>+15 Shield Block Rating</option>
				...
				<section class="sright" style="background-image: url(\'{path}TBC/CharacterDesigner/img/'.strtolower($this->gender[$this->genderid]).strtolower($this->race[$this->raceid]).'.png\');">
					<div class="urlbar">
					...
					<div class="gearframe">
						<div class="gleft">
							<div class="item qe'.$this->itemTemplate[$this->items[1]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[1]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[1].$this->getSocketString(1).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[2]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[2]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[2].$this->getSocketString(2).'&sockets='.$this->socketids[4].','.$this->socketids[5].','.$this->socketids[6].'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[3]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[3]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[3].$this->getSocketString(3).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[15]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[15]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[15].$this->getSocketString(15).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[5]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[5]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[5].$this->getSocketString(5).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[4]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[4]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[4].$this->getSocketString(4).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[19]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[19]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[19].$this->getSocketString(19).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[9]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[9]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[9].$this->getSocketString(9).'" target="_blank"><div class="b"></div></a>
							</div>
						</div>
						<div class="gmiddle">
						...
						<div class="gright">
							<div class="item qe'.$this->itemTemplate[$this->items[10]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[10]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[10].$this->getSocketString(10).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[6]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[6]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[6].$this->getSocketString(6).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[7]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[7]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[7].$this->getSocketString(7).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[8]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[8]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[8].$this->getSocketString(8).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[11]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[11]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[11].$this->getSocketString(11).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[12]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[12]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[12].$this->getSocketString(12).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[13]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[13]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[13].$this->getSocketString(13).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[14]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[14]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[14].$this->getSocketString(14).'" target="_blank"><div class="b"></div></a>
							</div>
						</div>
						<div class="gbottom">
							<div class="item qe'.$this->itemTemplate[$this->items[16]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[16]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[16].$this->getSocketString(16).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[17]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[17]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[17].$this->getSocketString(17).'" target="_blank"><div class="b"></div></a>
							</div>
							<div class="item qe'.$this->itemTemplate[$this->items[18]]->quality.' large" style="background-image: url(\'{path}Database/icons/large/'.$this->itemTemplate[$this->items[18]]->icon.'.jpg\');">
								<a href="https://tbc-twinhead.twinstar.cz/?item='.$this->items[18].$this->getSocketString(18).'" target="_blank"><div class="b"></div></a>
							</div>
						</div>
					</div>
