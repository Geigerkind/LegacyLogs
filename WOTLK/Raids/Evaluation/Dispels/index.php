				...
				foreach($va as $key => $var){
					$content .= '
							<tr>
								...
								<td><img src="{path}Database/icons/small/'.$table[5][$key][2].'.jpg" /><a rel="spell='.$key.'" href="https://wotlk-twinhead.twinstar.cz/?spell='.$this->spells[$key]->id.'" target="_blank">'.$table[5][$key][1].'</a></td>
								<td>'.$this->mnReadable($var).'</td>
							</tr>
					';
					$count++;
