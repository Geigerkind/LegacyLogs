...
function errorHandler($type, $str, $file, $line){
	header('Location: https://legacy-logs.com/404/');
	exit();
}
	...
	*/
	public function __connect() {
		try {
			...
			if (!strpos($_SERVER['REQUEST_URI'], "Backup"))
				setcookie("lasturl", $_SERVER['REQUEST_URI'], time()+3600, "/");
			header('Location: https://legacy-logs.com/Backup');
			exit();
