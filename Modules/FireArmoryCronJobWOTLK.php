...
require "ArmoryWOTLK.php";
require "../Database/Mysql.php";
require "ArmoryCronJobWOTLK.php";
...
class FireCronJob{
	...
	private function commit(){
		...
		foreach($this->possib as $key => $val){
			if ($this->db->query('SELECT id FROM armorycronjob WHERE active = 1 AND expansion = 2 AND id = '.$key)->rowCount()==0){
