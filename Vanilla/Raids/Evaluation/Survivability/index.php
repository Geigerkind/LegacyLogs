...
class Home extends Template{
	...
	public function content(){
		...
		foreach($this->db->query('SELECT a.charid, a.attemptid, a.cbt, b.cbtend, b.cbt as cbtstart FROM `v-raids-deaths` a LEFT JOIN `v-raids-attempts` b ON a.attemptid = b.id WHERE b.rdy = 1 AND b.rid = "'.$this->rid.'"'.$con) as $row){
