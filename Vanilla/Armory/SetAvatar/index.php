		...
		<div class="container" id="container">
			<section class="table">
				<div class="right">
					...
					<p>
						The wallpaper requires to be 640x542. You can download a package of templates that I used to generate the default wallpapers <a href="{path}Vanilla/Armory/SetAvatar/template.zip">here</a>.<br />
					...
					<p>
						...
						<form action="{path}Vanilla/Armory/SetAvatar/work.php" method="post" enctype="multipart/form-data">
